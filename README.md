...
Generate Open Graph images for your Astro site using Takumi, with additional fixes and future updates.
...
- Updated the Takumi version to 2.14.0
- ~~Resolved issue [#161](https://github.com/vikas5914/astro-takumi/issues/161) and [#159](https://github.com/vikas5914/astro-takumi/issues/159)~~ Original version also fixed these issues as well
...
There are example sites using this integration under [`examples/`](https://github.com/kayxue/astro-takumi-fork/tree/master/examples).

### Sites Using This

If you're using this project, [open a PR](https://github.com/kayxue/astro-takumi-fork/compare) to add your site to this list.

<!-- Add your site here! -->

## Custom Renderers

You can create your own custom images with a render function. Take a look at how [a preset](https://github.com/kayxue/astro-takumi-fork/blob/master/packages/astro-takumi-fork/src/presets/blackAndWhite.tsx) works.

Renderers have access to the page's DOM using [jsdom](https://github.com/jsdom/jsdom). You can use this to render your Open Graph image using any of the content from the associated HTML page. An example of this is shown in the [custom property preset](https://github.com/kayxue/astro-takumi-fork/blob/master/packages/astro-takumi-fork/src/presets/customProperty.tsx) which shows a preview of the page's body text in the Open Graph image.
...
Presets are located in [`src/presets/`](https://github.com/kayxue/astro-takumi-fork/tree/master/packages/astro-takumi-fork/src/presets). [Open a pull request](https://github.com/kayxue/astro-takumi-fork/compare) to contribute a preset you've created.
